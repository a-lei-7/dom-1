...
var div = dom.create("<div>createDiv</div>");
console.log(div);
dom.after(test, div);
...
var testColor = dom.style(test, 'color');
console.log("testColor: ".concat(testColor));
dom.class.add(test, 'red');
dom.class.add(test, 'blue');
dom.class.remove(test, 'blue');
console.log("test\u662F\u5426\u6709blue\u5C5E\u6027\uFF1A\n    ".concat(dom.class.has(test, 'blue')));
...
var testDiv = dom.find('#test2')[0]; //记得加下标
